  ...
  head () {
    return {
      ...
      meta: [
        ...
        { name: 'og:url', property: 'twitter:url', content: 'https://cathedrale-gothique.com/contact' },
        { name: 'og:title', property: 'twitter:title', content: this.$t('Contact.meta.title') },
        { name: 'og:description', property: 'twitter:description', content: this.$t('Contact.meta.description') },
