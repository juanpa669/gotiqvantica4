  ...
  head () {
    return {
      ...
      meta: [
        ...
        { name: 'og:description', 'property': 'og:description', 'content': this.$t('Contact.meta.description').replace(/<\/?[^>]+(>|$)/g, '') },
        { name: 'og:image', 'property': 'og:image', 'content': 'https://cathedrale-gothique.com/img/main/contact/chevalier.png' },
