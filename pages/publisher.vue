  ...
  head () {
    return {
      ...
      meta: [
        ...
        { name: 'og:url', property: 'og:url', content: 'https://cathedrale-gothique.com/publisher' },
        { name: 'og:title', property: 'og:title', content: this.$t('Editor.meta.title') },
        { name: 'og:description', property: 'og:description', content: this.$t('Editor.meta.description') },
