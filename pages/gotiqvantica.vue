  ...
  head () {
    return {
      ...
      meta: [
        ...
        { name: 'og:url', property: 'og:url', content: 'https://cathedrale-gothique.com/gotiqvantica' },
        { name: 'og:title', property: 'og:title', content: this.$t('Home.meta.title') },
        { name: 'og:description', property: 'og:description', content: this.$t('Home.meta.description') },
