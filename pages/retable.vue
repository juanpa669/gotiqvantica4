  ...
  head () {
    return {
      ...
      meta: [
        ...
        { name: 'og:url', property: 'og:url', content: 'https://cathedrale-gothique.com/retable' },
        { name: 'og:title', property: 'og:title', content: this.$t('Retable.meta.title') },
        { name: 'og:description', property: 'og:description', content: this.$t('Retable.meta.description') },
