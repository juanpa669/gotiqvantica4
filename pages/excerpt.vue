  ...
  head () {
    return {
      ...
      meta: [
        ...
        { name: 'twitter:card', property: 'twitter:card',  content: this.$t('Excerpt.meta.description') },
        ...
        { name: 'og:url', property: 'twitter:url', content: 'https://cathedrale-gothique.com/excerpt' },
        { name: 'og:title', property: 'twitter:title', content: this.$t('Excerpt.meta.title') },
        { name: 'og:description', property: 'twitter:description', content: this.$t('Excerpt.meta.description') },
